...
const TEMPLATES = [
  { slug: 'high-ticket-freelance', file: 'template-high-ticket-freelance.html', id: 'high-ticket-freelance-card', name: 'High-Ticket Freelance Blueprint', category: 'productivity-work', layout: 'split-dark-green', logo: 'tr', plainTitle: false, fields: ['PHOTO_LEFT', 'PHOTO_RIGHT', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'micro-saas-builder', file: 'template-micro-saas-builder.html', id: 'micro-saas-builder-card', name: 'Micro-SaaS Builder Insights', category: 'productivity-work', layout: 'steps-keyboard', logo: 'tl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'STEP1', 'STEP2', 'STEP3', 'STEP4', 'LOGO'] },
  { slug: 'solopreneur-systems', file: 'template-solopreneur-systems.html', id: 'solopreneur-systems-card', name: 'Solopreneur Systems & Automation', category: 'productivity-work', layout: 'grid4-title', logo: 'br', plainTitle: false, fields: ['PHOTO_1', 'PHOTO_2', 'PHOTO_3', 'PHOTO_4', 'TITLE', 'LOGO'] },
  { slug: 'remote-team-culture', file: 'template-remote-team-culture.html', id: 'remote-team-culture-card', name: 'Remote Team Culture Strategy', category: 'productivity-work', layout: 'quote-serif', logo: 'bl', plainTitle: false, fields: ['PHOTO', 'QUOTE', 'SUBTITLE', 'LOGO'] },
  { slug: 'ai-prompt-enterprise', file: 'template-ai-prompt-enterprise.html', id: 'ai-prompt-enterprise-card', name: 'AI Prompt Engineering for Enterprise', category: 'productivity-work', layout: 'glass-cosmic', logo: 'tr', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'container-home-design', file: 'template-container-home-design.html', id: 'container-home-design-card', name: 'Architectural Container Home Design', category: 'real-estate-living', layout: 'split-gradient-yellow', logo: 'tl', plainTitle: false, fields: ['PHOTO_LEFT', 'PHOTO_RIGHT', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'heritage-restoration', file: 'template-heritage-restoration.html', id: 'heritage-restoration-card', name: 'Heritage Home Restorations', category: 'real-estate-living', layout: 'split-labels', logo: 'tr', plainTitle: false, fields: ['PHOTO_LEFT', 'PHOTO_RIGHT', 'LEFT_LABEL', 'RIGHT_LABEL', 'TITLE', 'LOGO'] },
  { slug: 'biophilic-interior', file: 'template-biophilic-interior.html', id: 'biophilic-interior-card', name: 'Biophilic Interior Design', category: 'real-estate-living', layout: 'cream-box', logo: 'br', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'tiny-house-glamping', file: 'template-tiny-house-glamping.html', id: 'tiny-house-glamping-card', name: 'High-End Tiny House Glamping', category: 'real-estate-living', layout: 'grid4-rating', logo: 'tl', plainTitle: false, fields: ['PHOTO_1', 'PHOTO_2', 'PHOTO_3', 'PHOTO_4', 'TITLE', 'RATING_1_LABEL', 'RATING_1_SCORE', 'RATING_2_LABEL', 'RATING_2_SCORE', 'LOGO'] },
  { slug: 'commercial-re-syndication', file: 'template-commercial-re-syndication.html', id: 'commercial-re-syndication-card', name: 'Commercial Real Estate Syndication', category: 'real-estate-living', layout: 'drone-vignette', logo: 'bl', plainTitle: true, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  ...
  { slug: 'longevity-biohacking', file: 'template-longevity-biohacking.html', id: 'longevity-biohacking-card', name: 'Longevity Biohacking Protocols', category: 'health-longevity', layout: null, logo: 'tr', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'pediatric-neurodiversity', file: 'template-pediatric-neurodiversity.html', id: 'pediatric-neurodiversity-card', name: 'Pediatric Neurodiversity Support', category: 'health-longevity', layout: null, logo: 'bl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'athletic-sleep-optimization', file: 'template-athletic-sleep-optimization.html', id: 'athletic-sleep-optimization-card', name: 'Athletic Sleep Optimization', category: 'health-longevity', layout: null, logo: 'tl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'executive-ergonomics', file: 'template-executive-ergonomics.html', id: 'executive-ergonomics-card', name: 'Executive Ergonomics Lab', category: 'health-longevity', layout: null, logo: 'br', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'functional-medicine-nutrition', file: 'template-functional-medicine-nutrition.html', id: 'functional-medicine-nutrition-card', name: 'Functional Medicine Nutrition', category: 'health-longevity', layout: null, logo: 'tr', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'micro-angel-investing', file: 'template-micro-angel-investing.html', id: 'micro-angel-investing-card', name: 'Micro Angel Investing Playbook', category: 'finance-investing', layout: null, logo: 'tl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'agriculture-land-investing', file: 'template-agriculture-land-investing.html', id: 'agriculture-land-investing-card', name: 'Agriculture Land Investing', category: 'finance-investing', layout: null, logo: 'bl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'saas-acquisition-flip', file: 'template-saas-acquisition-flip.html', id: 'saas-acquisition-flip-card', name: 'SaaS Acquisition Flips', category: 'finance-investing', layout: null, logo: 'tr', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'web3-micro-grants', file: 'template-web3-micro-grants.html', id: 'web3-micro-grants-card', name: 'Web3 Micro Grants', category: 'finance-investing', layout: null, logo: 'br', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'dividend-growth', file: 'template-dividend-growth.html', id: 'dividend-growth-card', name: 'Dividend Growth Portfolios', category: 'finance-investing', layout: null, logo: 'bl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'nocode-enterprise', file: 'template-nocode-enterprise.html', id: 'nocode-enterprise-card', name: 'No-Code Enterprise Stacks', category: 'tech-saas', layout: null, logo: 'tl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'devops-automation', file: 'template-devops-automation.html', id: 'devops-automation-card', name: 'DevOps Automation Patterns', category: 'tech-saas', layout: null, logo: 'tr', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'privacy-data-engineering', file: 'template-privacy-data-engineering.html', id: 'privacy-data-engineering-card', name: 'Privacy-First Data Engineering', category: 'tech-saas', layout: null, logo: 'br', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'ai-ecommerce-personalization', file: 'template-ai-ecommerce-personalization.html', id: 'ai-ecommerce-personalization-card', name: 'AI Ecommerce Personalization', category: 'tech-saas', layout: null, logo: 'tl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'sustainable-supply-chain', file: 'template-sustainable-supply-chain.html', id: 'sustainable-supply-chain-card', name: 'Sustainable Supply Chain Design', category: 'tech-saas', layout: null, logo: 'bl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'deep-space-astrophoto', file: 'template-deep-space-astrophoto.html', id: 'deep-space-astrophoto-card', name: 'Deep Space Astrophotography', category: 'science-space', layout: null, logo: 'tr', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'quantum-computing', file: 'template-quantum-computing.html', id: 'quantum-computing-card', name: 'Quantum Computing Frontiers', category: 'science-space', layout: null, logo: 'br', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'deep-ocean-marine', file: 'template-deep-ocean-marine.html', id: 'deep-ocean-marine-card', name: 'Deep Ocean Marine Science', category: 'science-space', layout: null, logo: 'tl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'paleontology-dig', file: 'template-paleontology-dig.html', id: 'paleontology-dig-card', name: 'Paleontology Field Digs', category: 'science-space', layout: null, logo: 'bl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'materials-science', file: 'template-materials-science.html', id: 'materials-science-card', name: 'Advanced Materials Science', category: 'science-space', layout: null, logo: 'tr', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'cyberpunk-cinema', file: 'template-cyberpunk-cinema.html', id: 'cyberpunk-cinema-card', name: 'Cyberpunk Cinema Studies', category: 'pop-culture-media', layout: null, logo: 'br', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'indie-game-studio', file: 'template-indie-game-studio.html', id: 'indie-game-studio-card', name: 'Indie Game Studio Diaries', category: 'pop-culture-media', layout: null, logo: 'tl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'retro-anime-cells', file: 'template-retro-anime-cells.html', id: 'retro-anime-cells-card', name: 'Retro Anime Cel Collecting', category: 'pop-culture-media', layout: null, logo: 'tr', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'peak-tv-screenplay', file: 'template-peak-tv-screenplay.html', id: 'peak-tv-screenplay-card', name: 'Peak TV Screenplay Craft', category: 'pop-culture-media', layout: null, logo: 'bl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'true-crime-forensic', file: 'template-true-crime-forensic.html', id: 'true-crime-forensic-card', name: 'True Crime Forensic Files', category: 'pop-culture-media', layout: null, logo: 'br', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'bespoke-leather', file: 'template-bespoke-leather.html', id: 'bespoke-leather-card', name: 'Bespoke Leather Atelier', category: 'creative-artisans', layout: null, logo: 'tl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'brutalist-graphic-design', file: 'template-brutalist-graphic-design.html', id: 'brutalist-graphic-design-card', name: 'Brutalist Graphic Design', category: 'creative-artisans', layout: null, logo: 'tr', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'sustainable-haute-couture', file: 'template-sustainable-haute-couture.html', id: 'sustainable-haute-couture-card', name: 'Sustainable Haute Couture', category: 'creative-artisans', layout: null, logo: 'bl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'ceramic-arts', file: 'template-ceramic-arts.html', id: 'ceramic-arts-card', name: 'Ceramic Arts Studio', category: 'creative-artisans', layout: null, logo: 'br', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
  { slug: 'architectural-model-making', file: 'template-architectural-model-making.html', id: 'architectural-model-making-card', name: 'Architectural Model Making', category: 'creative-artisans', layout: null, logo: 'tl', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
