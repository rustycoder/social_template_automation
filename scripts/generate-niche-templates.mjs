...
const TEMPLATES = [
  ...
  { slug: 'remote-team-culture', file: 'template-remote-team-culture.html', id: 'remote-team-culture-card', name: 'Remote Team Culture Strategy', category: 'productivity', layout: 'quote-serif', logo: 'bl', plainTitle: false, fields: ['PHOTO', 'QUOTE', 'SUBTITLE', 'LOGO'] },
  ...
  { slug: 'deep-space-astrophoto', file: 'template-deep-space-astrophoto.html', id: 'deep-space-astrophoto-card', name: 'Deep Space Astrophotography', category: 'science', layout: null, logo: 'tr', plainTitle: false, fields: ['PHOTO', 'TITLE', 'SUBTITLE', 'LOGO'] },
